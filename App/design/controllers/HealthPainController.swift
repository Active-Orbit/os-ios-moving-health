...
class HealthPainController: BaseController {
    ...
    func setOnClickListeners() {
        ...
        nextButton.setOnClickListener {
            ...
            if self.isSelectionValid() {
                ...
                bundle.putInt(Extra.HEALTH_ANXIETY.key, self.anxietyResponse)
                bundle.putInt(Extra.HEALTH_PAIN.key, self.response)
                Router.instance
                    .controllerTransition(ControllerTransition.LEFT_TO_RIGHT)
                    .startBaseControllerForResult(self, Controllers.HEALTH_SCORE, bundle, HealthController.HEALTH_REQUEST_CODE)
            } else {
