//
//  HealthMobilityController.swift
//  App
//
...
class HealthMobilityController: BaseController {
    ...
    func setOnClickListeners() {
        ...
        nextButton.setOnClickListener {
            ...
            if self.isSelectionValid() {
                ...
                let bundle = Boundle()
                bundle.putInt(Extra.HEALTH_MOBILITY.key, self.response)
                Router.instance
                    .controllerTransition(ControllerTransition.LEFT_TO_RIGHT)
                    .startBaseControllerForResult(self, Controllers.HEALTH_SELFCARE, bundle, HealthController.HEALTH_REQUEST_CODE)
            } else {
