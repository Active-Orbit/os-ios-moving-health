//
//  HealthSelfCareController.swift
//  App
//
...
class HealthSelfCareController: BaseController {
    ...
    func setOnClickListeners() {
        ...
        nextButton.setOnClickListener {
            ...
            if self.isSelectionValid() {
                ...
                bundle.putInt(Extra.HEALTH_SELF_CARE.key, self.response)
                Router.instance
                    .controllerTransition(ControllerTransition.LEFT_TO_RIGHT)
                    .startBaseControllerForResult(self, Controllers.HEALTH_USUAL_ACTIVITIES, bundle, HealthController.HEALTH_REQUEST_CODE)
            } else {
