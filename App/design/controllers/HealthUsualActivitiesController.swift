//
//  HealthUsualActivitiesController.swift
//  App
//
...
class HealthUsualActivitiesController: BaseController {
    ...
    func setOnClickListeners() {
        ...
        nextButton.setOnClickListener {
            ...
            if self.isSelectionValid() {
                ...
                bundle.putInt(Extra.HEALTH_ACTIVITY.key, self.response)
                Router.instance
                    .controllerTransition(ControllerTransition.LEFT_TO_RIGHT)
                    .startBaseControllerForResult(self, Controllers.HEALTH_ANXIETY, bundle, HealthController.HEALTH_REQUEST_CODE)
            } else {
